    ...
    public class StoryNodeEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            if (_useDefaultInspector)
            {
                ...
                {
                    Undo.RecordObject(_storyNode, $"Changed {_storyNode.GetName()} Description");
                    _storyNode.description = evt.newValue;
                    EditorUtility.SetDirty(_storyNode);
                });
        ...
        protected void OnDebugElement(VisualElement root)
        {
