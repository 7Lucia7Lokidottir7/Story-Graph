...
namespace PG.StorySystem.NodesEditor
{
    ...
    [CustomEditor(typeof(Use3DSliderNode), true)]
    internal class Use3DSliderNodeEditor : InteractNodeEditor
    {
        private Use3DSliderNode _useSliderNode;
        protected override void Init()
        {
            base.Init();
            _useSliderNode = target as Use3DSliderNode;
        }
