...
namespace PG.StorySystem
{
    ...
    public class StoryNodeView : Node
    {
        ...
        public StoryNodeView(StoryNode node) : base(AssetDatabase.GetAssetPath(Resources.Load("StoryGraph/StoryNodeView")))
        {
            MainStyle(node);
        ...
        protected void MainStyle(StoryNode node)
        {
            ...
            Label nameNode = this.Q<Label>("nameNode-label");
            nameNode.text = node.nameNode;
        }
