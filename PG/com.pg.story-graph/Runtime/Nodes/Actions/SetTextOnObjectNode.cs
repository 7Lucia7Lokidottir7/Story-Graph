    ...
    public class SetTextOnObjectNode : ActionNode
    {
        ...
        protected override void OnStart(StoryGraph storyGraph)
        {
            ...
            else
            {
                if (_useLocalization)
                {
                    _textObject.text = CSVLocalizationManager.Instance != null ? CSVLocalizationManager.Instance.GetLocalizedValue(textKey, text) : text;
                }
                else
                {
                    _textObject.text = text;
        ...
        IEnumerator PrintText(StoryGraph storyGraph)
        {
            ...
            if (_useLocalization)
            {
                newText = CSVLocalizationManager.Instance != null ? CSVLocalizationManager.Instance.GetLocalizedValue(textKey, text) : text;
            }
            else
            {
                newText = text;
